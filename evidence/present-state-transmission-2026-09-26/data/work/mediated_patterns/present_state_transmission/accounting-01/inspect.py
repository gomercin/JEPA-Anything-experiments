...
m.save_json(out/'protocol.json',{'command':['inspect.py'],'scientific_execution':False,'analysis':'saved outcomes and fixed inference timings; no fit or solver'})
