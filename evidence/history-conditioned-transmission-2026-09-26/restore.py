"""Verify/restore only the new history data using the existing safe-copy convention."""
...
SPEC = importlib.util.spec_from_file_location(
    "history_copy_helpers", HERE.parent / "organization-response-2026-09-25/restore.py"
)
helpers = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(helpers)
helpers.PREFIX = "work/mediated_patterns/history_conditioned_transmission/"
